...
Read PURPOSE and SCHEMA before any write operation under `docs/`. For application code outside `docs/`, read PURPOSE and relevant ADRs first. Do not duplicate rules here; this file only routes you to the authoritative sources.

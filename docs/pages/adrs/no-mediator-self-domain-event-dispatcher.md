...
related: [pages/adrs/backend-architecture-equinox-reference.md, pages/adrs/engineering-skeleton-v0.md, pages/adrs/architecture-test-assertion-strategy.md, pages/adrs/api-entry-facade-and-v0-endpoints.md, pages/adrs/port-and-cross-layer-contract-assembly-split.md, pages/rules/plan-first-implementation.md]
